...
$(document).ready(function() {
    ...
    var GlobalChart = new Object();



    var labels = GlobalMois;
    ...
    $('#lieu-select').change(function() {
        ...
        // console.log("Au début du changement d'année GlobalChart c'est ça : " + GlobalChart);



        refreshStats(GlobalChart);
...
function refreshStats(GlobalChart) {



    // console.log("au début du refresh GlobalChart c'est ça : " + GlobalChart);
    ...
    $.ajax({
        ...
        success: function(html){
            ...
            // console.log("Avant le generateChartConfig() GlobalChart c'est ça : " + GlobalChart);



            generateChartConfig(GlobalChart);
...
function generateChartConfig(GlobalChart){



    // console.log("Au début du generateChartConfig() GlobalChart c'est ça : " + GlobalChart);
    ...
    generateChart(config, GlobalChart);
...
function generateChart(config, GlobalChart){



    // console.log("Au début du generateChart() GlobalChart c'est ça : " + GlobalChart);



    function removeData(GlobalChart) {

        GlobalChart.data.labels.pop();
    ...
    removeData(GlobalChart);



    GlobalChart.data.labels = GlobalMois;



    GlobalChart.data.datasets[0].data = GlobalCas;

    GlobalChart.data.datasets[1].data = GlobalDeces;
    ...
    // console.log("labels : " + GlobalChart.data.labels);

    // console.log("data 1 : " + GlobalChart.data.datasets[0].data);

    // console.log("data 2 : " + GlobalChart.data.datasets[1].data);



    // console.log("GlobalChart c'est ça : " + GlobalChart);
